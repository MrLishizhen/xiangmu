<template>
	<div class="emil_page">
		<div class="input_emil input">
			<span class="layel">邮箱：</span>
			<div class="input_box">
				<input type="text" v-model="emil" placeholder="请输入网易邮箱登录......" >
				<span class="emil_hz">@163.com</span>
			</div>
		</div>
		...
		<div class="button" :class="{oks:denglu&&clause}" @click="denglu&&clause?login():''" >邮箱登录</div>
		<div class="clause">
